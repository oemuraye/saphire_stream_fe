  ...
  return (
    <section className='join_socials container text-white py-2'>
      ...
      <section>
        ...
        {/* {missionStarted === false && (<div role='button' className='start-mission basic-gradient my-3 h3'>Start mission</div>)} */}
      </section>
      ...
      <section className='mission-tasks my-3'>
        ...
        <div className="mission_tasks d-flex flex-column gap-2 mt-2">
          <div className='taskPad w-100 col-6 d-flex gap-2 align-items-center justify-content-between rounded-3 py-3 px-2 gap-2'>
            ...
            {/* <h6 className={missionStarted ? "text-white" : "muted-color"}>Join the Telegram chat</h6> */}
            {/* {missionStarted && (<Link className='go-mission basic-gradient fw-bold py-2 px-4'>Go</Link>)} */}
          </div>
          <div className='taskPad w-100 col-6 d-flex gap-2 align-items-center justify-content-between rounded-3 py-3 px-2 gap-2'>
            <h6 className="muted-color">Follow X handle</h6>
            {/* <h6 className={missionStarted ? "text-white" : "muted-color"}>Follow X handle</h6> */}
            {/* {missionStarted && (<Link className='go-mission basic-gradient fw-bold py-2 px-4'>Go</Link>)} */}
          </div>
          <div className='taskPad w-100 col-6 d-flex gap-2 align-items-center justify-content-between rounded-3 py-3 px-2 gap-2'>
            <h6 className="muted-color">Visit website</h6>
            {/* <h6 className={missionStarted ? "text-white" : "muted-color"}>Visit website</h6> */}
            {/* {missionStarted && (<Link className='go-mission basic-gradient fw-bold py-2 px-4'>Go</Link>)} */}
          </div>
        </div>
      </section>
      ...
      <section>
        {/* {missionStarted && (<div className='end-mission my-3 h3'>Finish mission</div>)} */}
      </section>
    </section>
  )
}
