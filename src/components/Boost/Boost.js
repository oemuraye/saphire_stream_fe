      ...
      <section className='boost_section container'>
        ...
        <section className='daily-boosters text-white my-3'>
          ...
          <section className="d-flex justify-content-between align-items-center gap-2">
            <div onClick={() => openModal(flameIcon, 'Taping Guru')} className='taskPad col-6 d-flex gap-2 align-items-center rounded-3 py-3 px-2 gap-2'>
            ...
            <div onClick={() => openModal(flameIcon, 'Full Task')} className='taskPad col-6 d-flex gap-2 align-items-center rounded-3 py-3 px-2 gap-2 ms-1'>
              <img src={flameIcon} alt="taskIcon" width="40px" height="" />
              <div className="d-flex flex-column">
                <h6>Full Task</h6>
                <div className=''>
